...
[[barrier_java]]
https://github.com/gallir/concurrencia_source_samples/blob/master/semaphores/Barrier.java[Barrier.java]
[source, java]
----
...
[[rw_lock_fair_py]]
https://github.com/gallir/concurrencia_source_samples/blob/master/semaphores/rw_lock_fair.py[rw_lock_fair.py]
