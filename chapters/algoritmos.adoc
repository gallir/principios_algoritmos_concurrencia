...
Para dos procesos estén en la sección crítica tiene que ocurrir que puedan entrar dos o más con el mismo número. Pero el uso del ID único y con relación de precedencia asegura que en estos casos siempre habrá uno de ellos que será el _menor_ y el único que saldrá del último bucle.
