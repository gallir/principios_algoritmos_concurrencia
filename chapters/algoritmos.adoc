...
El gran problema es que no cumple la regla de _sin esperas infinitas_, de hecho el algoritmo genera un _interbloqueo_ si se da la siguiente secuencia de intrucciones:
