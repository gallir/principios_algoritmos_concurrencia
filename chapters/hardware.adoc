...
Esta instrucción intercambia atómicamente dos posiciones de memoria, usualmente enteros de 32 o 64 bits. No todas las arquitecturas la tienen, en Intel es XCHG para enteros de 32 bits. Esta función está implementada <<Atomics>> con el confuso nombre de ___sync_lock_test_and_set_ pero realmemte ekjecuta la instrucción XCHG y devuelve el valor anterior de la primer variable.

Si algoritmo es siumilar al genérico:
