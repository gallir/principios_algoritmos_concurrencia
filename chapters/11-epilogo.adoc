...
[quote]
Nos cuesta reconocer que ignoramos más de lo que conocemos. También nuestra historia y las personas que la hicieron posible.


=== Cincuenta años de historias de personas

1963::
El matemático holandés Theodorus Jozef Dekker inventa un algoritmo de exlusión mutua para dos procesos.
...
+
Ingenieros de IBM diseñan e implementan la instrucción _compare&swap_ en la arquitectura 370/XA.
...
A Marc Pàmpols que me dio acceso remoto a una Raspberry Pi 2 mientras esperaba la mía.
...
A mi familia, que tuvo que aguantar un zombi en casa durante siete meses.
