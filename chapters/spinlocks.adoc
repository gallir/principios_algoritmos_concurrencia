...
En los siguientes dos gráficos se puede oberservar el tiempo de retorno medido en _tiempo de reloj_ de los algoritmos anteriores para el Xeon de 16 núcleos y el ARM v7 de Raspberry 2.

.Tiempo de retorno en Intel Xeon 16 núcleos
image::optimized-xeon-real.png[align="center"]

.Tiempo de retorno en ARMv7 de Raspberry 2 cuatro núcleos
