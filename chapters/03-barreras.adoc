...
Además del incremento notable de tiempo de CPU –casi 70 veces más–, el resultado sigue siendo erróneo. No se cumple la exclusión mutua y se _pierden_ operaciones, como si no hubiese control de acceso.
...
- Una barrera _acquire_ es de _sentido único_ (+ATOMIC_ACQUIRE+) y garantiza que todas las operaciones de memoria posteriores a la barrera _parecerán_ haber ocurrido después. Las anteriores pueden ejecutarse antes y fuera de orden.
