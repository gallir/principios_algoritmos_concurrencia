...
Las transacciones pueden ser anidadas, son útiles porque pueden ser abortadas sin abortar al padre.
...
Desde la versión 4.8 _libitm_ detecta las extensiones de _HTM_ de hardware de Intel y desde 4.9 de los procesadores PowerPC e IBM S/390 y los usa en el _fastpath_
