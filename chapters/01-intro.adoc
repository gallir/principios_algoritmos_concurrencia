...
El rendimiento y _velocidad aparente_ del sistema depende en gran medida de las decisiones del planificador. Éstas tienen requisitos contradictorios, de los cuales los más importantes son:
