...
Para gestionar los procesos el núcleo mantiene las complejas estructuras de datos, las _tablas de control de procesos_, con información de contexto y estado de cada uno. Por ejemplo, los valores de los registros del procesador cuando el proceso fue interrumpido, tablas de páginas de memoria, estado de entradas y salidas, información de propiedad, etc.
