...
Simular las instrucciones_LL/SC_ con _CAS_ o _TAS_ es más complicado –si no imposible– por lo que GCC no incluye macros para emularlas. Tuvimos que recurrir a ensamblador para poder usarlas en procesadores ARM.
