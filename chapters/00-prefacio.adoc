...
No hice un extenso análisis de mercado, no obstante, me di cuenta de que me resultaba imposible recomendar un libro. No encontraba uno que explicase Concurrencia de la forma que consideraba adecuada para un programador interesado en aprender sus fundamentos: riguroso explicando los principios pero sin exagerar con abstracciones formales y académicas.
