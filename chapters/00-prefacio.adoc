...
No se requieren ni se suponen conocimientos de concurrencia. Solo conocimientos de programación, estructuras de datos básicas (pilas, colas, listas), fundamentos muy básicos de programación orientadas a objetos y comprender lo que es un puntero o referencia a memoria.
