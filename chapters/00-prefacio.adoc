...
Al momento de escribir estas líneas no sé si habrá una versión impresa del libro. No contacté con ninguna editorial, ya que la intención desde el principio fue hacer un _ebook_ que fuese accesible, compacto y con ejemplos razonablemente fáciles de leer. No fue tarea sencilla pero fui muy cuidadoso en estos aspectos y creo que el resultado es bueno. En vez de inventar otro pseudocódigo usé directamente Python: no solo es expresivo, es fácil de comprender y los programas además son válidos.
