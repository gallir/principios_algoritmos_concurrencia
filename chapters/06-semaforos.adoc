...
<3> Se usa con dos propósitos: 1) asegurar exclusión mutua para verificar y modificar la variable +readers+, y 2) como barrera (el primer lector bloqueará a los siguientes si hay un escritor en la sección crítica).
