...
El ordenador que generó esos resultados _anómalos_ es un _Thinkpad X1_ con procesador _Intel(R) Core(TM) i5-2520M CPU @ 2.50GHz_, el sistema operativo es Ubuntu 15.04 y la versión 1.3.3 de Go. En Github https://github.com/gallir/concurrencia/blob/master/measurements/logs/measures_mutex_go.log[está disponible] el registro de las pruebas usadas para el gráfico. Poco después otra persona obtuvo resultados similares con un i7-4770K y Go 1.4.2 (https://github.com/gallir/concurrencia/blob/master/measurements/logs/i7-4770K-go_mutex.png[imagen en Github]).
====
